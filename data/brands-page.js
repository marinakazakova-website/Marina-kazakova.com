/* ========================================================================
   ...
   i18n: each stage's `meta.goal/scope/result/timing` is prose or a tag
   list that actually changes with the language switch, so each is
   `{ en, ru }`; `team` is the client's own English role title and
   stays a single string used in both languages, per her mockup.
   Method nav, workflow step
...
window.BRANDS_PAGE_DATA = {
  ...
  duration: {
    en: "Strategic Brand Partnership — 6+ months",
  ...
  stages: [
    {
      ...
      meta: {
        goal: {
          en: "Gather and analyse information about the brand, market, industry and audience to understand its current position and potential, and define a strategic roadmap for its further development and market expression.",
        ...
        // Scope is the client's own English term list; RU carries a real
        // translation (see i18n note in the header comment above), team
    ...
    },
    {
      ...
      meta: {
        ...
        scope: {
          en: "Visual Direction · Brand Identity · Art Direction · Graphic System · Photography · Video · Content System · Digital / Web Direction",
          ru: "Визуальное направление · Айдентика бренда · Арт-дирекшн · Графическая система · Концепция фото контента · Видео · Контент-система · Digital / Web направление"
        },
        result: {
    ...
    },
    {
      ...
      meta: {
        ...
        scope: {
          en: "Product Strategy · Product Portfolio · Offer · Packaging · Pricing logic · Customer Journey · Service · Digital Experience · Retail / Offline Experience",
          ru: "Продуктовая стратегия · Продуктовая линейка · Упаковка · Логика ценообразования · Customer Journey · Сервис · Digital Experience · Retail Experience"
        },
        result: {
          ...
          ru: "«Система продукта и клиентского опыта» — продуктовая система, предложение, упаковка, путь клиента и опыт взаимодействия с продуктом в digital и physical space."
        },
        ...
        timing: {
          ...
          ru: "2–4 недели для сервисных продуктов / 6–8 недель для физических продуктов"
        }
      },
      layout: "row3",
      ...
      workflow: [
        {
          ...
          caption: {
            ...
            ru: "Формирование продукта: что бренд продаёт, кому, в каком формате, из чего состоит продукт или услуга, какой результат получает клиент и сколько это стоит."
          },
          result: {
        ...
        },
        {
          ...
          caption: {
            ...
            ru: "Построение продуктовой системы: как связаны разные предложения бренда — входные, основные и premium — и какие новые форматы можно создать на базе существующих ресурсов."
          },
          result: {
        ...
        },
        {
          ...
          caption: {
            ...
            ru: "Упаковка и продвижение продукта: описание, customer journey, sales materials, web-презентация и коммуникация продукта."
          },
          result: {
    ...
    },
    {
      ...
      meta: {
        goal: {
          ...
          ru: "Реализовать позиционирование бренда через систему релевантных маркетинговых активностей — в digital, физическом пространстве, PR, событиях, партнёрствах и документальном кино — и выстроить их в долгосрочную систему развития бренда."
        },
        scope: {
          en: "Digital & SMM Launch · PR · Collaborations · Partnerships · Events · Influencers · Brand Activations · Growth",
          ru: "Запуск в Digital и SMM · Создание PR стратегии · Коллаборации · Партнёрства · События · Инфлюенсеры · Бренд-активации · Развитие и рост"
        },
        result: {
      ...
      workflow: [
        ...
        },
        {
          ...
          caption: {
            ...
            ru: "Разработка, съёмка и продвижение документального фильма о бренде как долгосрочного актива — через фестивали, стриминговые платформы и культурные медиа."
          }
        }
      ]
    }
